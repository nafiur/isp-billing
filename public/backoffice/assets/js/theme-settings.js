                    ...
                    c
                        ? ((d = c.querySelectorAll(".collapse")),
                          Array.from(d).forEach(function (a) {
                              (a = bootstrap.Collapse.getInstance(a)) !== b &&
                                  a.hide();
                          }))
                        : ((d = (function (b) {
    ...
    function t() {
        ...
        b &&
            ...
            ((c = document.createElement("ul")).innerHTML =
                '<a href="{{ route("dashboard") }}" class="logo"><img src="assets/img/logo.png" alt="User Image" height="22"></a>'),
            Array.from(
                document
    ...
    function A(a) {
        if (a.target && a.target.matches("a.nav-link span")) {
            if (0 == u(a.target.parentElement.nextElementSibling)) {
                ...
                Array.from(c.querySelectorAll(".menu-dropdown")).forEach(
                    function (a) {
    ...
    function G(a, b) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(
            ...
            Array.from(
                ...
                1 == a.checked &&
                    new bootstrap.Collapse(b, { toggle: !1 }).show(),
                    document
            ...
            Array.from(
                ...
                var collapseBgGradient = document.querySelector(
                    "[data-bs-target='#collapseBgGradient']"
                );
                var formCheckInput = document.querySelector(
                    "#collapseBgGradient .form-check input:checked"
                );
                if (formCheckInput) {
                    collapseBgGradient &&
                        collapseBgGradient.classList.add("active");
                } else {
                    collapseBgGradient &&
                        collapseBgGradient.classList.remove("active");
                }
