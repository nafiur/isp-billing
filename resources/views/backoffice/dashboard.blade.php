                            ...
                            <table class="table table-stripped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-04.jpg') }}" alt="User Image">Barbara Moore</a>
                                            </h2>
                                        </td>
                                        <td>$118</td>
                                        <td>23 Nov 2020</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-06.jpg') }}" alt="User Image">Karlene Chaidez</a>
                                            </h2>
                                        </td>
                                        <td>$222</td>
                                        <td>18 Nov 2020</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-08.jpg') }}" alt="User Image">Russell Copeland</a>
                                            </h2>
                                        </td>
                                        <td>$347</td>
                                        <td>10 Nov 2020</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-10.jpg') }}" alt="User Image">Joseph Collins</a>
                                            </h2>
                                        </td>
                                        <td>$826</td>
                                        <td>25 Sep 2020</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-11.jpg') }}" alt="User Image">Jennifer Floyd</a>
                                            </h2>
                                        </td>
                                        <td>$519</td>
                                        <td>18 Sep 2020</td>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-05.jpg') }}" alt="User Image"> Greg Lynch</a>
                                            </h2>
                                        </td>
                                        <td>5 Nov 2020</td>
                                        <td>$175</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-07.jpg') }}" alt="User Image"> John Blair</a>
                                            </h2>
                                        </td>
                                        <td>17 Oct 2020</td>
                                        <td>$2350</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('backoffice/assets/img/profiles/avatar-09.jpg') }}" alt="User Image"> Leatha Bailey</a>
                                            </h2>
                                        </td>
                                        <td>30 Sep 2020</td>
                                        <td>$785</td>
